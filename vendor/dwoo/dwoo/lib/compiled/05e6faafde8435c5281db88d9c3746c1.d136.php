...
<a asp-action="Surroundings" class="text-center explore-more"><h2>EXPLORE MORE !</h2></a>
    <p class="para">
    ...
    <p></p>
    <div class="row">
        <div class="col-lg-3 col-md-4 col-sm-6 col-xs-12 clear-padding">
            <div class="tile">
                <h3>Easy Access</h3>
