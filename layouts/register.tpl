                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input class="form-control" type="email" data-val="true" data-val-email="The Email field is not a valid e-mail address."
                            data-val-required="The Email field is required." id="email_id" name="email_id" value="{$email}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input class="form-control" type="password" data-val="true" data-val-equalto="The password and confirmation password do not match."
                            data-val-equalto-other="*.Password" id="confirmpassword" name="confirmpassword" value="{$password}">
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <textarea class="form-control" type="text" rows="2" data-val="false" data-val-required="The Address 1 field is required."
                            id="address_line_one" name="address_line_one">{$address1}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <textarea class="form-control" type="text" rows="2" data-val="false" data-val-required="The Address 2 field is required."
                            id="address_line_two" name="address_line_two">{$address2}</textarea>
                ...
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input class="form-control" type="text" data-val="true" data-val-required="The Contact No field is required." id="contact_no"
                            name="contact_no" value="{$contactNo}">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-4">
                            <select class="form-control" name="role" id="role">
                                <option {$registered} value="2">Registered User</option>
                                <option {$admin} value="1">Admin User</option>
                                <option {$nonRegistered} value="3">Non-Registered</option>
                                <option {$deactivated} value="0">Deactivated</option>
                            </select>
                        </div>
                    </div>
