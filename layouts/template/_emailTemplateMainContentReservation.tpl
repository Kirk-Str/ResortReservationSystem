<table width="447" cellspacing="0" cellpadding="0" border="0" bgcolor="#fff2e6">
          <tbody>
             ...
             <tr>
                ...
                <td width="291" valign="top" height="18" bgcolor="#FEFCF5"><font face="Verdana" color="#001F3E" size="1">{$reservation_id}</font></td>
             </tr>
             <tr>
                <td width="180" valign="top" height="18" bgcolor="#fefcf5">
                   <p style="MARGIN-LEFT: 10px; MARGIN-RIGHT: 6px"><font face="Verdana" color="#001F3E" size="1">Guest Name:</font></p>
                </td>
                <td width="291" valign="top" height="18" bgcolor="#fefcf5"><font face="Verdana" color="#001F3E" size="1">{$guest_name}</font>
                </td>
             </tr>
             <tr>
                <td width="180" valign="top" height="18" bgcolor="#fefcf5">
                ...
                <td width="291" valign="top" height="18" bgcolor="#fefcf5"><font face="Verdana" color="#001F3E" size="1">{$check_in_date}</font>
                </td>
             </tr>
             <tr>
                <td width="180" valign="top" height="18" bgcolor="#fefcf5">
                ...
                <td width="291" valign="top" height="18" bgcolor="#fefcf5"><font face="Verdana" color="#001F3E" size="1">{$check_out_date}</font>
                </td>
             </tr>
             <tr>
                <td width="180" valign="top" height="18" bgcolor="#fefcf5">
                ...
                <td width="291" valign="top" height="18" bgcolor="#fefcf5"><font face="Verdana" color="#001F3E" size="1">{$no_nights_stay}</font></td>
             </tr>
             <tr>
                <td width="180" valign="top" height="18" bgcolor="#fefcf5">
                   <p style="MARGIN-LEFT: 10px; MARGIN-RIGHT: 6px"><font face="Verdana" color="#001F3E" size="1">Adults:</font></p>
                </td>
                <td width="291" valign="top" height="18" bgcolor="#fefcf5"><font face="Verdana" color="#001F3E" size="1">{$adults}</font></td>
             </tr>
             <tr>
                <td width="180" valign="top" height="18" bgcolor="#fefcf5">
                   <p style="MARGIN-LEFT: 10px; MARGIN-RIGHT: 6px"><font face="Verdana" color="#001F3E" size="1">Children:</font></p>
                </td>
                <td width="291" valign="top" height="18" bgcolor="#fefcf5"><font face="Verdana" color="#001F3E" size="1">{$children}</font></td>
             </tr>
             <tr>
                <td width="180" valign="top" height="18" bgcolor="#fefcf5">
                   <p style="MARGIN-LEFT: 10px; MARGIN-RIGHT: 6px"><font face="Verdana" color="#001F3E" size="1">Room Type:</font></p>
                </td>
                <td width="291" valign="top" height="18" bgcolor="#fefcf5"><font face="Verdana" color="#001F3E" size="1">{$room_type}</font>
                </td>
             </tr>
             <tr>
                <td width="180" valign="top" height="18" bgcolor="#fefcf5">
                ...
                <td width="291" valign="top" height="18" bgcolor="#fefcf5"><font face="Verdana" color="#001F3E" size="1">{$total_amount}</font>
                </td>
             </tr>
             <tr>
                <td width="180" valign="top" height="18" bgcolor="#fefcf5">
                ...
                <td width="291" valign="top" height="18" bgcolor="#fefcf5"><font face="Verdana" color="#001F3E" size="1">{$paid_amount}</font>
                </td>
             </tr>
             <tr>
                <td width="180" valign="top" height="18" bgcolor="#fefcf5">
                ...
                <td width="291" valign="top" height="18" bgcolor="#fefcf5"><font face="Verdana" color="#001F3E" size="1">{$balance_amount}</font>
                </td>
             </tr>
             <tr>
                <td width="180" valign="top" height="18" bgcolor="#fefcf5">
                ...
                <td width="291" valign="top" height="18" bgcolor="#fefcf5"><font face="Verdana" color="#001F3E" size="1">{$room_rate} per room 
