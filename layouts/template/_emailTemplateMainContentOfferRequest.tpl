<table width="500" cellspacing="0" cellpadding="0" border="0" bgcolor="#ffffff">
    <tbody>
        ...
        <td width="291" valign="top" height="10"><font face="Verdana" color="#001F3E" size="1">{$request_id}</font></td>
        </tr>
        <tr>
        <td width="180" valign="top" height="10">
        ...
        <td width="291" valign="top" height="10"><font face="Verdana" color="#001F3E" size="1">{$paid_amount}</font>
        </td>
        </tr>
        <tr>
        <td width="180" valign="top" height="10">
        ...
        <td width="291" valign="top" height="10"><font face="Verdana" color="#001F3E" size="1">{$balance_amount}</font>
        </td>
        </tr>
        <tr>
        <td width="180" valign="top" height="10">
