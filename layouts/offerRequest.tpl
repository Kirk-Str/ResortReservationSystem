        ...
        <div class="body">
            <table class="margin-offset-1 text-left">
                <tr>
                    ...
                    <td class="label-1-sub">{$offer_caption}</td>
                </tr>
            </table>
            ...
            <table class="margin-offset-1 text-left">
                <tr>
                    ...
                    <td class="label-1-sub">{$rate_per_guest}</td>
                </tr>
            </table>
        </div>
    </div>
                    ...
                    <form method="POST" action="./actions/offerRequest.php?type=add">
                        ...
                        <div class="form-horizontal">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control" type="text" data-val="true" data-val-required="The Start At field is required." id="event_start_date"
                                        name="event_date_range" value="{$start_at}" {$disabled} required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control" type="text" value="{$end_at}" data-val="true" data-val-required="The End At field is required."
                                        id="event_end_date" name="event_date_range" {$disabled} required>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <input class="form-control" type="number" value="{$guests}" data-val="true" data-val-required="The Guests field is required."
                                        id="guests" name="guests" {$disabled}>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control" type="text" rows="2" data-val="false" data-val-required="The Addtional Request / Note field is required."
                                        id="note" name="note" {$disabled}>{$note}</textarea>
